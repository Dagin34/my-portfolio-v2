...
<nav
    class="fixed top-0 left-0 w-full z-100 transition-all duration-500 ease-in-out px-4 py-3 md:px-10 border-b border-border-color
    {scrolled
    ...
    <div class="max-w-7xl mx-auto px-6 py-2">
        <div class="flex items-center justify-between">
            <a
                href="/"
                onclick={closeMenu}
                class="group flex items-center text-2xl font-semibold tracking-tighter relative z-200"
            >
                <span
                    class="group-hover:text-brand-primary transition-all ease-in duration-150"
                    >Dagmawi</span
                >
                <span
                    class="group-hover:text-white text-brand-primary transition-all ease-in duration-150"
                    >{".et"}</span
                >
            </a>
    ...
    >
        ...
        >
            {#each navLinks as link, i}
                <li class="overflow-hidden">
                    ...
                    >
                        <span
                            class="text-sm font-mono text-brand-primary opacity-50 mr-4"
                            >0{i + 1}.</span
                        >
                        {link.label}
                    </a>
        ...
        >
            <a
                ...
                target="_blank"
                class="hover:text-brand-primary transition-colors">Github</a
            >
            <a
                href="https://linkedin.com/in/dagin34"
                target="_blank"
                class="hover:text-brand-primary transition-colors">LinkedIn</a
            >
            <a
                href="mailto:dagmawinapoleon02@gmail.com"
                class="hover:text-brand-primary transition-colors">Email</a
            >
        </div>
    </div>
{/if}
